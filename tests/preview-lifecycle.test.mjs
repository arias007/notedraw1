...
test("a non-empty note waits for rendered Markdown before mounting NoteDraw1", () => {
...
test("an empty note can still mount NoteDraw1 after its reading surface exists", () => {
